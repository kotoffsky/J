					...
					<fieldset>
							...
							<fieldset>
								<div class="form-group">
									<label class="control-label col-sm-4" for="categorie">Domaine <span class="required">*</span>
									</label>
									<div class="col-sm-8">
										<form:input type="text" path="categorie" id="categorie" name="categorie"
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
											...
											<form:textarea path="desc" id="desc" class="form-control input-transparent"
												type="text" name="desc" required="required"/>
