						...
						<form id="user-form" class="form-horizontal form-label-left"
									...
									<div class="col-sm-8">
										<div id="gender" class="btn-group" data-toggle="buttons">
											<label class="btn btn-default"
												...
												type="radio" name="gender" value="male"> &nbsp; Masculin
												&nbsp;
							...
							<fieldset>
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
											<input id="email" type="email" data-trigger="change"
												required="required" class="form-control input-transparent"
												name="email">
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-xs-12 col-sm-8">
										<div class="input-group">
											...
											<span class="input-group-btn"> <select id="phone-type"
							...
							<fieldset>
								...
								<div class="form-group">
									<label for="address" class="control-label col-sm-4">Addresse
										<span class="required">*</span>
									</label>
									<div class="col-sm-8">
										
											<input id="address" class="form-control input-transparent"
												type="text" name="address">
										
										<input id="address-2"
											class="form-control input-transparent mt-sm" type="text"
											value="" name="address-2">
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-xs-12 col-sm-6">
										<input id="city" class="form-control input-transparent"
